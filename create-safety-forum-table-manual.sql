-- =====================================================
-- MANUAL: Create Safety Forum Table
...
CREATE TABLE IF NOT EXISTS safety_forum (
  ...
  waktu_selesai TIME,
  unit_id UUID, -- REFERENCES units(id) ON DELETE SET NULL, -- Commented out until units table exists
  ...
  -- Pimpinan & Peserta
  ketua_forum UUID, -- REFERENCES pegawai(id), -- Commented out until pegawai table exists
  notulen_by UUID, -- REFERENCES pegawai(id), -- Commented out until pegawai table exists
  ...
  forum_sebelumnya_id UUID, -- REFERENCES safety_forum(id), -- Self reference
  ...
  approved_by UUID, -- REFERENCES pegawai(id), -- Commented out until pegawai table exists
  ...
  created_by UUID, -- REFERENCES pegawai(id), -- Commented out until pegawai table exists
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_by UUID -- REFERENCES pegawai(id), -- Commented out until pegawai table exists
);
