<template>
  <div class="min-h-screen flex bg-gray-50">
    ...
    <aside class="w-72 h-screen bg-gradient-to-b from-primary-900 to-primary-800 text-white shadow-2xl fixed left-0 top-0 z-30">
      ...
      <div class="p-6 border-b border-primary-700">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h1 class="text-2xl font-bold">W3Safe</h1>
            <p class="text-xs text-primary-200">Safety Management</p>
          </div>
        </div>
      </div>
    ...
    <!-- App Title Container - Always on Top -->
    <div class="fixed top-0 left-72 right-0 z-50 bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg">
      <div class="px-6 py-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h1 class="text-xl font-bold">W3Safe</h1>
                <p class="text-xs text-primary-100">Safety Management</p>
              </div>
            </div>
            <div class="hidden md:block w-px h-8 bg-white/20"></div>
            <div class="hidden md:flex items-center space-x-2 text-sm text-primary-100">
          ...
          <div class="flex items-center space-x-4">
            <div class="text-right">
              ...
              <p class="text-xs text-primary-200">{{ userInitials }}</p>
            </div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="relative">
              ...
              >
                ...
                <button
                  @click="handleLogout"
                  class="w-full flex items-center px-4 py-3 text-sm text-danger-600 hover:bg-danger-50 transition-colors"
                >
