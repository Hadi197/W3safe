          ...
          <div v-if="activeTab === 1" class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select v-model="formData.unit_id" required class="w-full px-3 py-2 border rounded-lg" :disabled="!authStore.isAdmin">
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  <div class="col-span-2">
                    ...
                    <input type="file" accept="image/*" capture="environment"
                      @change="handleUnsafeConditionPhotoUpload($event, idx)"
                      class="hidden"
                      :ref="`cameraInput-unsafe-${idx}`"
                    />
                    <div class="flex gap-2">
                      <button type="button"
                        @click="($refs[`cameraInput-unsafe-${idx}`] as any)?.[0]?.click()"
